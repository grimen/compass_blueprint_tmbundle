...
This is the first release of this bundle, and I suspect that some (or worst case most) of the keyboard shortcuts for constants and mixins might change (keyboard shortcuts don't make much of sense now). TextMate bundles don't support aliased shortcuts, which is a bit of pain in the ass.
